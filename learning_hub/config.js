...
window.LEARNING_HUB_CONFIG = Object.freeze({
  ...
  routes: {
    ...
    allLearningPaths: { url: "", target: "_top" },
  ...
  sharePoint: {
    ...
    lists: {
      ...
      learningPaths: {
        title: "Learning Hub - Learning Paths",
        select: ["Id", "Title", "TitleZh", "Audience", "Summary", "ModuleCount", "Duration", "Theme", "LinkUrl", "IsActive", "SortOrder"],
        filter: "IsActive eq 1",
